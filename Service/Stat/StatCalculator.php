...
class StatCalculator
{
     ...
     * @return int
     */
    public function calculateCount(Product $product, Group $group, \DateTime $from, \DateTime $to)
    {
        $query =
...
WHERE iq.parent_id IS NULL
  ...
  AND o.state IN ('accepted', 'completed');";
     ...
     * @return array
     */
    public function calculateCross(Product $product, Group $group, \DateTime $from, \DateTime $to)
    {
        $query =
