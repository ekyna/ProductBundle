 ...
 */
class BrandRepository extends SearchRepository implements Locale\LocaleProviderAwareInterface
{
    ...
    protected function createResult($source, Request $request): ?Result
    {
        ...
        return $result
            ...
            ->setRoute('admin_ekyna_product_brand_read') // TODO Use resource/action
