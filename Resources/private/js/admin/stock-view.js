define(
    ...
    function nextList() {
        ...
        productsXhr = $.ajax({
            url: Router.generate('admin_ekyna_product_stock_view_products', {page: page}),
            method: 'GET',
            dataType: 'json',
            data: getContext()
        });
    ...
    function handleResponse(data) {
        ...
        $.each(data.products, function (index, product) {
            const $new = $(Templates['@EkynaProduct/Js/stock_view_line.html.twig'].render(product)),
    ...
    $body.on('click', 'a.quick-edit', function (e) {
        return requestModal(e, 'admin_ekyna_product_stock_view_quick_edit', true);
    });
    ...
    $body.on('click', 'a.stock-units', function (e) {
        return requestModal(e, 'admin_ekyna_product_stock_view_stock_units', true);
    });
    ...
    $body.on('click', 'a.treatment', function (e) {
        return requestModal(e, 'admin_ekyna_product_stock_view_customer_orders', true);
    });
    ...
    $('button[name="batch_submit"]').on('click', function(e) {
        ...
        return requestModal(e, 'admin_ekyna_product_stock_view_batch_edit', {id: ids});
    });
