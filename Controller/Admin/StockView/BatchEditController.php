...
use Ekyna\Bundle\ProductBundle\Form\Type\StockView\BatchEditType;
...
class BatchEditController extends AbstractController
{
    ...
    public function __invoke(Request $request): Response
    {
        ...
        $form = $this->formFactory->create(BatchEditType::class, null, [
            'action' => $this->urlGenerator->generate('admin_ekyna_product_stock_view_batch_edit', [
                'id' => $ids,
            ]),
            'attr'   => [
        ...
        $modal = new Modal('stock_view.button.batch_edit');
        $modal
            ...
            ->setVars([
                'form_template' => '@EkynaProduct/Admin/StockView/_batch_edit_form.html.twig',
                'products'      => $products,
            ]);
